...
RSpec.describe Profile, type: :model do
  ...
  it { should validate_inclusion_of(:gre_quant).in_range(130..170)}
  it { should validate_inclusion_of(:gre_verbal).in_range(130..170)}
  it { should validate_inclusion_of(:gre_writing).in_range(0..6)}
