...
RSpec.describe Student, type: :model do
  ...
  it "should return profile of the student" do
    ...
    mock_profile = Profile.new(gre: 200, toefl: 100, cgpa: 3.4, interested_major: 'Computer Science', interested_term: 'fall', interested_year: 2019)
    student.profile = mock_profile
    assert(student.current_profile.student_id).eql?(1)
    assert(student.current_profile.gre).eql?(mock_profile.gre)
