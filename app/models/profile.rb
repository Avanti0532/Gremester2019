...
class Profile < ActiveRecord::Base
  ...
  validates_inclusion_of :gre_quant, :in => 130..170, allow_blank: true
  validates_inclusion_of :gre_verbal, :in => 130..170, allow_blank: true
  validates_inclusion_of :gre_writing, :in => 0..6, allow_blank: true
  validates_inclusion_of :toefl, :in => 0..120, allow_blank: true
  validates_numericality_of :cgpa, :greater_than_or_equal_to => 0, allow_blank: true
  validates_numericality_of :year_work_exp, :greater_than_or_equal_to => 0, allow_blank: true
  validates_numericality_of :month_work_exp, :greater_than_or_equal_to => 0, allow_blank: true
